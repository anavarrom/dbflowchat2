...
@RestController
@RequestMapping("/api/dbflowchat-2-kafka")
public class Dbflowchat2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Dbflowchat2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Dbflowchat2KafkaResource(KafkaProperties kafkaProperties) {
